...
```{r, echo = FALSE}
totalOdds_na <- totalOddsControls
...
for (row_name in rownames(totalOddsControls)) {
  ...
  # Crear el texto para la fila actual
  ...
  # Asignar el texto creado a la nueva columna
...
if (nrow(above_one) > 0) {
  comparisons <- strsplit(above_one$y, "/")  
...
if (nrow(under_one) > 0) {
  comparisons <- strsplit(under_one$y, "/")  
  translated_text <- lapply(comparisons, function(cmp) {
    cmp_split <- strsplit(cmp[2], " vs ")[[1]]
...
for (row_name in rownames(totalOddsCases)) {
  ...
  new_column_text <- paste(
    ...
    paste(split_despues_del_slash[1], " Control individuals changed:", totalOddsCases[row_name, "SUMCCFirst"], "<br>", sep = " "),
    paste(split_despues_del_slash[2], " Control individuals changed:", totalOddsCases[row_name, "SUMCCSecond"], "<br>", sep = " "),
    paste(split_despues_del_slash[1], " Control individuals unchanged:", totalOddsCases[row_name, "SUMCMFirst"], "<br>", sep = " "),
    paste(split_despues_del_slash[2], " Control individuals unchanged:", totalOddsCases[row_name, "SUMCMSecond"], "<br>", sep = " ")
  )
